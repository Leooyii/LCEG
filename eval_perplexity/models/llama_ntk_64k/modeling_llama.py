...
class LlamaDynamicNTKScalingRotaryEmbedding(LlamaRotaryEmbedding):
    ...
    def __init__(self, dim, max_position_embeddings=2048, base=10000, device=None, scaling_factor=1.0, base_factor=1.0):
        self.scaling_factor = scaling_factor
    ...
    def _set_cos_sin_cache(self, seq_len, device, dtype):
        ...
        if seq_len > 65536:
            ...
            base = self.base * (
                (self.scaling_factor * 65536 / self.max_position_embeddings) - (self.scaling_factor - 1)
            ) ** (self.dim / (self.dim - 2))
